...
<html>
  ...
  <head>
    <title> Explore | Omek Houreya </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../">Omek Houreya</a>
        </div>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Omek Houreya</h1>      
    <p>Let food be the medicine and medicine be the food</p>
  </div>
</div>
...
<form method="post" action="whishlist.php?action=add1&id=<?php echo $row["F_ID"]; ?>">
<div class="mypanel" align="center";>
<img src="<?php echo $row["images_path"]; ?>" class="img-responsive">
<h5 class="text-info"><?php echo $row["name"]; ?></h5>
<h5 class="text-info"><?php echo $row["description"]; ?></h5>
<h5 class="text-info">DT : <?php echo $row["price"]; ?></h5>
<h5 class="text-info">Quantity: <input type="number" min="1" max="25" name="quantity" class="form-control" value="1" style="width: 60px;"> </h5>
<input type="hidden" name="hidden_name" value="<?php echo $row["name"]; ?>">
<input type="hidden" name="hidden_price" value="<?php echo $row["price"]; ?>">
<input type="hidden" name="hidden_RID" value="<?php echo $row["R_ID"]; ?>">
<input type="submit" name="add" style="margin-top:5px;" class="btn btn-success" value="Add to Cart">
<input type="submit" name="add1" style="margin-top:5px;" class="btn btn-success" value="Add to whishlist" formaction="whishlist.php" >
