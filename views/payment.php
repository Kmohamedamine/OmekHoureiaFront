...
$gtotal = 0;
  ...
  {
    $order = new order($values["food_id"], $values["food_name"],$values["food_price"], $values["food_quantity"], date('Y-m-d'), $_SESSION["username"], $values["R_ID"]);
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        <br>
<h1 class="text-center">Grand Total: <?php echo "$gtotal"; ?>DT</h1>
...
<h1 class="text-center">
  ...
  <a href="contactus.php"><button class="btn btn-success"><span class="glyphicon glyphicon-credit-card"></span> Delivery</button></a>
...
<br><br><br><br><br><br>
  ...
  <br>
  <p> Omek Houreya 2020 | &copy All Rights Reserved </p>
  <br>
  </footer>
</html>